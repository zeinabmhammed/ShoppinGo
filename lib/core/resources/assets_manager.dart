...
abstract class ImageAssets {
  static const String routeLogo = "$imagePath/";
  static const String splashBackground = "$imagePath/splash_background.png";
  static const String splashLogo = "$imagePath/splashScreen.png";
  ...
  static const String categoryHomeImage = "$imagePath/womanFashion.jpg";
  ...
  static const String brandHomeImage = "$imagePath/brandsImage.jpg";
  static const String productImage = "$imagePath/product_image.png";

  static const String rate = "$imagePath/rate.png";

  static const String shoppingCart = "$imagePath/shoppingcart.png";
...
class SvgAssets{
  static const String routeLogo = "$svgPath/routeAppbar.svg";
  static const String eye = "$svgPath/Eye.svg";
  static const String edit = "$svgPath/edit.svg";
}

abstract class IconsAssets {
  static const String _icCategory = "$iconsPath/category.png";
  static const String _icHome = "$iconsPath/home.png";
  static const String _icProfile = "$iconsPath/profile.png";
  static const String _icWithList = "$iconsPath/heart.png";
  ...
  static const String _icAddToCart = "$iconsPath/add_to_cart.png";
  ...
  static String get icAddToCart => _icAddToCart;
}
